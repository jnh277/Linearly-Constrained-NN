...
do
  ...
  # for i in {1..2}
    do
        ...
        # runs python
       python3 experiment_2D_reg.py --weight_decay 0.001 --n_data ${nd} --save_file n_data_study_reg001/exp_${nd}_trial_${i} --epochs 400 --scheduler 1
    done
done

#Use ctl+alt arrow to move across, sweet, thanks all good