...
for nd in 200 300 400 500 1000 1500 2000 2500 3000 3500 4000
# for nd in 100
do
    ...
    do
        python experiment_2D.py --n_data 2000 --save_file n_data_study/exp_${nd}_trial_${i} --epochs 400 --scheduler 1
    done
done