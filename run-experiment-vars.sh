...
python experiment_2D.py --n_data ${ND} --save_file hcp/exp_${ND}_trial_${I} --epochs 400 --scheduler 1
#python experiment_2D_reg.py --weight_decay 0.01 --n_data ${ND} --save_file n_data_study_reg01/exp_${ND}_trial_${I} --epochs 20 --scheduler 1
